pretalx ActivityLog Webhook plugin
==========================

This is a plugin for `pretalx`_.
pretalx plugin for ActivityLog Webhook
...
2. Clone this repository, eg to ``local/pretalx-activitylog-webhook``.
...
Copyright 2025 Adam Skrzymowski
